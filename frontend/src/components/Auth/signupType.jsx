      ...
      <div className="w-full lg:w-1/2 p-4 md:p-8 bg-white">
        <div className="mb-6 md:mb-8">
          ...
          <p className="text-sm md:text-base text-gray-600">
            Choose how you'd like to contribute to positive change
          </p>
        </div>
        ...
        <div className="mb-3 md:mb-4 p-4 md:p-6 border rounded-lg hover:border-[#3767a6] hover:bg-[#96b3d9]/10 cursor-pointer transition-all duration-300">
          <div className="flex items-center gap-2 md:gap-3">
            <svg
              className="w-5 h-5 md:w-6 md:h-6 text-[#3767a6] flex-shrink-0"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24">
              <path
            ...
            <div>
              <h3 className="font-semibold text-[#3767a6] text-sm md:text-base">
                Non Profit Organization
              </h3>
              <p className="text-gray-600 text-xs md:text-sm">
                Create an impact-driven fundraising platform for your non-profit
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-3 md:mb-4 p-4 md:p-6 border rounded-lg hover:border-[#3767a6] hover:bg-[#96b3d9]/10 cursor-pointer transition-all duration-300">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 text-xs md:text-sm">
                Set up fundraising for your mission-driven business or
                organization
              </p>
            </div>
          </div>
        ...
        <div className="mb-3 md:mb-4 p-4 md:p-6 border rounded-lg hover:border-[#3767a6] hover:bg-[#96b3d9]/10 cursor-pointer transition-all duration-300">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 text-xs md:text-sm">
                Start a personal fundraising campaign for yourself or others
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-3 md:mb-4 p-4 md:p-6 bg-gradient-to-r from-[#96b3d9]/10 to-amber-50 rounded-lg">
          <h3 className="font-semibold text-[#333333] text-sm md:text-base">
            Access Existing Account
          </h3>
          <Link
            to="/contact"
            className="text-amber-600 hover:text-amber-700 hover:underline text-xs md:text-sm">
        ...
        <div className="mt-4 md:mt-6 text-sm md:text-base">
          ...
          <Link
            to="/signin"
            className="text-[#3767a6] hover:text-[#96b3d9] font-medium hover:underline text-sm sm:text-base">
            ...
            {[
              ...
              <div key={index} className="flex items-center gap-2 md:gap-3">
                <div className="p-1.5 md:p-2 bg-amber-500/20 rounded-full">
                  <svg
                    className="w-4 h-4 md:w-5 md:h-5 text-amber-300"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path
